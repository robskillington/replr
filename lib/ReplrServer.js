...
(function() {
  var EventEmitter, MemoryStream, ReplrClient, ReplrEvents, ReplrServer, Util, async, chalk, cluster, http, merge, net, portscanner, terminal,
  ...
  ReplrServer = (function(_super) {
    ...
    ReplrServer.prototype.open = function(socket, overriddenOptions) {
      ...
      clientOptions = merge(overriddenOptions, this.options);
